  ...
  return (
    <div className="space-y-6">
      ...
      {step === 2 && (
        ...
        {/* User Contact */}
<div className="relative bg-gradient-to-br from-black/40 to-black/20 
                p-5 rounded-2xl border border-gray-700/60 
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
    <div className="group flex flex-col bg-black/40 p-4 rounded-xl 
